<?
	global $os,$dbc;
	$counting = $dbc->GetRecord("os_users","*","id=".$_GET['id']);
?>
<div class="card container">
	...
	<?php
		echo '<dl class="row">';
			echo '<dt class="col-sm-3">ID</dt><dd class="col-sm-9">'.$counting['id'].'</dd>';
			echo '<dt class="col-sm-3">Name</dt><dd class="col-sm-9">'.$counting['name'].'</dd>';
		echo '</dl>';
	?>
	</div>
